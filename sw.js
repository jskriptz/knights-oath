...
const CACHE_NAME = 'knights-oath-25.58.2-1a1cf398';
...
// Install: precache core assets and activate immediately (forced update)
...
// Also listen for manual skip waiting message from page (fallback)
